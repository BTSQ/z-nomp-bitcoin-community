# Bitcoin Community - Node Open Mining Portal

**[Click here for the official - Zcash® Zclassic, Bitcoin Community Stratum Mining Pool Installation Guide](https://zdeveloper.org/wiki:z-nomp_install)**
...
http://pool.aliyinke.com - Bitcoin Community Pool
...
sudo n stable
git clone https://github.com/btsq/z-nomp-bitcoin-community.git z-nomp-bitcoin-community
cd z-nomp-bitcoin-community
npm update
npm install
```
...
* [Fcases](//github.com/Fcases) - ordered me a BTSQ <3
